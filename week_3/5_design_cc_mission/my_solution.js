...
// The action takes place on a simple board; there are no walls or other obstacles.
// Tharin must rescue the princess, who is at the opposite end of the field.
// Two ogres race in from the sides to stop Tharin.  What will happen?
	...
	// CREATE A FUNCTION TO CONCATENATE EACH ROW INTO A STRING OF THAT ROW's COLUMNS
		...
		// For each spot in the rowString, determine if any/many/no character belongs in the spot
			...
			// for each of the characters, check to see if their location matches the spot being searched
					...
					// ALSO if a match, then also increment the number-of-matches variable
...
// CREATE CHARACTER PROTOTYPE(CLASS?) WITH PROPERTIES AND MOVEMENT FUNCTIONS
	...
	// Set up character movement functions
...
// Refactored Code (streamlined gameplay and widened board)
...
// Reflection
/*
This challenge had its ups and downs.  On the one hand, I really had trouble even understanding what we 
were supposed to be doing.  I spent some time searching for a spot on Code Combat where I could set up 
my own mission, but I then realized that wasn’t the challenge.  Instead the challenge was to think 
about creating my own mission.  How on earth do I do that?  I spent most of my time thinking about
how I would create a space in which I could create a mission.  How do I visually represent that space 
and any characters on the console?  My mission ended up being super simple.

On the other hand, I found this challenge pretty invigorating.  The last two weeks on HTML and CSS 
have made me learn a lot and try to get comfortable with being uncomfortable and ignorant.  I found it 
somewhat interesting, but the material also made me question whether DBC was right for me.  This 
challenge put me back on track, joyfully staying up late and waking up early to try to figure out 
the code.

Since I was having a good time with it, I considered making the play more involved, adding additional 
objects (sabres, magic wands, etc.) or even user interactivity.  I’m pretty confident I would be able 
to do this.  It would take me several more hours, but I’d probably enjoy those hours.  However, I’m 
not going to do that.

Instead, I’m going to try to focus my time on other things.  I know I love coding, so I don’t 
necessarily need to spend time doing something I’m sure I could do (even if it would still be 
challenging).  Following the mentality of Shareef’s kitchen v. table video (which I really think 
should be called kitchen v. front-of-house or kitchen v. customer to better drive the point home), 
I'm going to more proactively decide how to use the challenges to further my developer education.  
I’ve realized that DBC is somewhat like law school—they ask you to do an enormous amount of work and 
then say that that is really the bare minimum.  I need to focus not on assignments or intermediate 
tasks but on long-term knowledge creation; the assignments/tasks are merely tools and checkpoints 
to get to that knowledge.

I note that even though I feel comfortable with certain programming concepts in JavaScript, I don’t 
yet get how to use it to create interactivity on a web page.  I assume that’s a big deal, and I’ll 
try to focus on that during my time this week.
